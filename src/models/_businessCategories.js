...
const categoriesToArrayInAlphabeticalOrder = categories.split("\n").filter(category => category.trim() !== "").sort()
categoriesToArrayInAlphabeticalOrder.unshift("") /* empty option */

const _businessCategories = categoriesToArrayInAlphabeticalOrder

export default _businessCategories
